...
@auth_router.post('/login', summary="Access creation and token refresh.",
...
@auth_router.post('/test-token', summary="Test to verify if token is valid.", response_model=UserOut)
